...
def mayus(update, context):
    resultado = str.upper(context.args[0])
...
def main():
    ...
    updater = Updater("1223807853:AAEiP4ROcd0FzNY1QcdvYIElCdKA9aZ8jTg", use_context=True)
    ...
    dp.add_handler(MessageHandler(None, alreves))
